...
func TestCheckFrontmatter_Name(t *testing.T) {
	t.Run("missing name", func(t *testing.T) {
		...
		requireResult(t, results, skillcheck.Error, "name is required")
	})

	t.Run("valid name matching dir", func(t *testing.T) {
		s := makeSkill("/tmp/my-skill", "my-skill", "A description")
		results := CheckFrontmatter(s)
		requireResult(t, results, skillcheck.Pass, `name: "my-skill" (valid)`)
		requireNoResultContaining(t, results, skillcheck.Error, "name")
	})
	...
	t.Run("name too long", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResult(t, results, skillcheck.Error, "name exceeds 64 characters (65)")
	})

	t.Run("name with uppercase", func(t *testing.T) {
		s := makeSkill("/tmp/My-Skill", "My-Skill", "A description")
		results := CheckFrontmatter(s)
		requireResultContaining(t, results, skillcheck.Error, "must be lowercase alphanumeric")
	})
	...
	t.Run("name does not match directory", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResultContaining(t, results, skillcheck.Error, "name does not match directory name")
	})
	...
	t.Run("numeric name", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResult(t, results, skillcheck.Pass, `name: "123" (valid)`)
	})
}
...
func TestCheckFrontmatter_Description(t *testing.T) {
	t.Run("missing description", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResult(t, results, skillcheck.Error, "description is required")
	})

	t.Run("valid description", func(t *testing.T) {
		s := makeSkill("/tmp/my-skill", "my-skill", "A valid description")
		results := CheckFrontmatter(s)
		requireResultContaining(t, results, skillcheck.Pass, "description: (19 chars)")
	})
	...
	t.Run("description too long", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResult(t, results, skillcheck.Error, "description exceeds 1024 characters (1025)")
	})

	t.Run("whitespace-only description", func(t *testing.T) {
		s := makeSkill("/tmp/my-skill", "my-skill", "   \t\n  ")
		results := CheckFrontmatter(s)
		requireResult(t, results, skillcheck.Error, "description must not be empty/whitespace-only")
	})
}
...
func TestCheckFrontmatter_KeywordStuffing(t *testing.T) {
	...
	t.Run("description with many quoted strings and little prose", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResultContaining(t, results, skillcheck.Warning, "quoted strings")
		requireResultContaining(t, results, skillcheck.Warning, "what the skill does and when to use it")
	})
	...
	t.Run("prose with supplementary trigger list is fine", func(t *testing.T) {
		...
		s := makeSkill("/tmp/my-skill", "my-skill", desc)
		results := CheckFrontmatter(s)
		requireNoResultContaining(t, results, skillcheck.Warning, "quoted strings")
		requireNoResultContaining(t, results, skillcheck.Warning, "keyword")
	})
	...
	t.Run("comma-separated keyword list", func(t *testing.T) {
		...
		s := makeSkill("/tmp/my-skill", "my-skill", desc)
		results := CheckFrontmatter(s)
		requireResultContaining(t, results, skillcheck.Warning, "comma-separated segments")
		requireResultContaining(t, results, skillcheck.Warning, "what the skill does and when to use it")
	})
	...
	t.Run("legitimate list of features is fine", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireNoResultContaining(t, results, skillcheck.Warning, "keyword")
		requireNoResultContaining(t, results, skillcheck.Warning, "comma-separated")
	})
	...
	t.Run("only one warning when both heuristics match", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResultContaining(t, results, skillcheck.Warning, "quoted strings")
		requireNoResultContaining(t, results, skillcheck.Warning, "comma-separated segments")
	})
...
func TestCheckFrontmatter_Compatibility(t *testing.T) {
	t.Run("valid compatibility", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResultContaining(t, results, skillcheck.Pass, "compatibility:")
	})
	...
	t.Run("compatibility too long", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResult(t, results, skillcheck.Error, "compatibility exceeds 500 characters (501)")
	})
}
...
func TestCheckFrontmatter_Metadata(t *testing.T) {
	t.Run("valid string metadata", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResultContaining(t, results, skillcheck.Pass, "metadata: (2 entries)")
	})
	...
	t.Run("metadata with non-string value", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResultContaining(t, results, skillcheck.Error, "metadata[\"count\"] value must be a string")
	})
	...
	t.Run("metadata not a map", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResult(t, results, skillcheck.Error, "metadata must be a map of string keys to string values")
	})
}
...
func TestCheckFrontmatter_OptionalFields(t *testing.T) {
	t.Run("license present", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResult(t, results, skillcheck.Pass, `license: "MIT"`)
	})
	...
	t.Run("allowed-tools string", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResult(t, results, skillcheck.Pass, `allowed-tools: "Bash Read"`)
		requireNoResultContaining(t, results, skillcheck.Info, "YAML list")
	})
	...
	t.Run("allowed-tools list emits info", func(t *testing.T) {
		...
		results := CheckFrontmatter(s)
		requireResult(t, results, skillcheck.Pass, `allowed-tools: "Read Bash Grep"`)
		requireResultContaining(t, results, skillcheck.Info, "YAML list")
		requireResultContaining(t, results, skillcheck.Info, "space-delimited string")
	})
}
...
func TestCheckFrontmatter_UnrecognizedFields(t *testing.T) {
	...
	results := CheckFrontmatter(s)
	requireResult(t, results, skillcheck.Warning, `unrecognized field: "custom"`)
}
